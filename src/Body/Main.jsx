  ...
  return (
    ...
    <div className="Maindiv">
      <div className='imagesection'>
        <img src="/Teamimage.jpg"alt='Teamimage'/>

      </div>
      <div className='paragraphsection'>
        <p>The Next Education Consultancy has a long-standing reputation of being one of the most comprehensive study abroad consultants in Nepal. Our head office is at Dillibazar, Kathmandu, Nepal. We have a support office in Sydney and branches at Parsa, Birtamode, Pokhara, Nawalparasi, Chitwan, Butwal in Nepal.<br/><br/>
